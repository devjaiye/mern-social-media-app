...
const Navbar = () => {
    ...
    const isNonMobileScreens = useMediaQuery("min-width: 1000px") //..coming from mui
  ...
  return (
      ...
      sx={{
        ...
        {/* If it's a mobile screen show this  */}
        {isNonMobileScreens && (
        ...
        <FlexBetween gap='2rem'>
          ...
          {!isNonMobileScreens && isMobileMenuToggled && (
            ...
            >
              ...
              gap='3rem' justifyContent='center' alignItems='center'>
